...
<!-- Subtle demo note -->
<p class="demo-note">
Adding a website works, but scraping only supports sites with the same structure as the
default targets.
</p>
...
<label>
Name
<input v-model.trim="form.name" type="text" placeholder="e.g. My News Source"
required />
</label>
<label>
Market
...
URL
<input v-model.trim="form.url" type="url" placeholder="https://example.com/target-
page" required />
</label>
</div>
